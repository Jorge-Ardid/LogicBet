# -*- coding: utf-8 -*-
"""v2 «Elo + Home Advantage».

Як v1, але домашній команді додається 70 пунктів Elo (стандартна
домашня перевага в очікуванні Elo).
"""
import math

ID = "outcomes_v2"
NAME = "Elo + Home Advantage"
SECTOR = "outcomes"
_HFA = 70.0
...
def predict(ctx):
    h = (ctx.get("home_elo") or 1500.0) + _HFA
